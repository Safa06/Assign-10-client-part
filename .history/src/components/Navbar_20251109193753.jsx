  ...
  return (
    <div className="navbar bg-base-100">
      ...
      {/* <div className="navbar-center hidden md:flex">
        <ul className="menu menu-horizontal px-1 gap-10 text-pink-800 font-bold text-xl">
          <li>
            <NavLink to={"/"}>
              <GoHomeFill />
              Home
      ...
      <div className="navbar-end gap-3 ">
        <ul className="menu menu-horizontal px-1 gap-10 text-pink-800 font-bold text-md flex justify-center items-center">
          <li>
            <NavLink to={"/"}>
              <GoHomeFill />
              Home
