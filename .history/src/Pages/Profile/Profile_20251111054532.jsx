...
const MyProfile = () => {
  ...
  return (
    <div className="mt-10 flex justify-center items-center bg-pink-200 border-2 border-pink-800 rounded-2xl">
      <title className="text-pink-800 font-bold">Profile</title>
