...
const Register = () => {
  ...
  return (
    <div className="card bg-pink-100 mx-auto max-w-4xl shadow-2xl border-2 border-pink-800">
        ...
        <form onSubmit={handleRegister}>
          <fieldset className="fieldset mt-6">
            ...
            <input
              type="text"
              name="displayName"
              className="input rounded-2xl focus:border-2 border-pink-800 focus:outline-gray-200 mb-5 display:block"
              placeholder="Name"
            />
