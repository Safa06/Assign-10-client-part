      ...
      <div className="card-body">
        ...
        <form onSubmit={handleRegister}>
          <fieldset className="fieldset">
            {/* email field */}
            <label className="label text-lg text-gray-600 font-semibold">Name</label>
            <input
              type="text"
              name="displayName"
              className="input rounded-2xl focus:border-2 border-pink-800 focus:outline-gray-200 mb"
              placeholder="Name"
            />
