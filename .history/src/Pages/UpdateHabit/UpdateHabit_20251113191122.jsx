...
const UpdateHabit = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`https://habit-ten-xi.vercel.app/all-habits/${models._id}`, {
      method: "PUT",
      headers: {
      ...
      <div className="card-body p-6 relative">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              defaultValue={models.description}
              name="description"
              required
              rows="3"
