    ...
    <div>
      ...
      <div className="text-center font-bold mt-10 text-pink-800">
        ...
        <div className="flex justify-center items-center gap-6">
          <div className="bg-linear-to-r from-purple-700 via-purple-500 to-purple-300 py-8 px-8 rounded text-white font-bold text-xl">
            <img
              src={focus}
              className=" w-20 h-20 rounded text-white font-bold text-xl"
              alt=""
            />
          ...
          <div className="bg-linear-to-r from-orange-700 via-orange-500 to-orange-300 py-8 px-8 rounded text-white font-bold text-xl">
