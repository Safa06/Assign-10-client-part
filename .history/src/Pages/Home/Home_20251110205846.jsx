    ...
    <div>
      ...
      <div>
        ...
        >
          ...
          <Marquee className="mt-8 rounded-xl bg-amber-200 h-20" gradient={false} speed={50}>
            {motivationQuotes.map((quote, i) => (
              <span
                key={i}
                className="text-lg text-gray-700 bg-pink-200 rounded-xl px-4 py-4 italic mx-10 whitespace-nowrap"
              >
                “{quote}”
              </span>
            ))}
